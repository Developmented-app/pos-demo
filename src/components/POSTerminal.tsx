...
export default function POSTerminal({
  ...
  const handlePOSOrderCompletion = (method: "Cash" | "Bakong_KHQR", extTxId?: string) => {
    ...
    const activeCustomer = customers.find(c => c.id === selectedCustomerId) || DEFAULT_CUSTOMERS[0];
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-12 gap-5 h-[calc(100vh-6rem)] overflow-hidden select-none animate-fade-in relative">
      ...
      <div className="xl:col-span-5 bg-white border border-gray-200 rounded-xl flex flex-col h-full overflow-hidden shadow-sm">
        ...
        <div className="p-3 border-b border-gray-200 bg-slate-50/50 flex items-center justify-between gap-3 shrink-0">
          ...
          <button
            ...
            className="mt-4 p-1.5 bg-orange-50 text-orange-600 border border-orange-100 rounded hover:bg-orange-100 transition"
